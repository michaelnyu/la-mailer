function buildEmail({ name, state }) {
    return {
      ...
      My name is ${name || "[YOUR NAME HERE]"}. I am a resident of ${state || "[STATE]"} and I am emailing today to demand accountability for the racist murder of Breonna Taylor.\n\n
